...
const FAKE_PROFILES = [
  ...
  { name: 'Pooja',   age: 22, bio: 'Aspiring chef 🍳 | Cricket fan | Born and raised in Soro', gender: 'woman', interested_in: 'men' },
  ...
  { name: 'Tanvi',   age: 20, bio: 'Fashion lover 👗 | Soro born and proud | Makeup is my art form', gender: 'woman', interested_in: 'men' },
